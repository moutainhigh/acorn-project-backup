...
public class ChamaInputDetectController {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ChamaInputDetectController.class);
    @Autowired
