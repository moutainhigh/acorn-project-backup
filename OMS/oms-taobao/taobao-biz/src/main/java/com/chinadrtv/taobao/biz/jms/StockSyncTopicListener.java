 ...
 * 
 */
public class StockSyncTopicListener extends JmsListener<Object>{
	
	private static transient final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(StockSyncTopicListener.class);
	...
	public void messageHandler(Object msg) throws Exception {
		...
		try {
			...
			stockSyncService.syncStockByShop(configList);
