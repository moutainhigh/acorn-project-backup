package com.chinadrtv.postprice.controller;

import com.chinadrtv.postprice.biz.PostpriceBizHandler;
import com.chinadrtv.postprice.model.ImportInfo;
import com.chinadrtv.postprice.model.ResultInfo;
...
public class ManualController {
    ...
    {
        logger.info("begin manual post price calc");
        ...
        try
        {
            ...
            for(int i=0;i<3;i++)
            {
                if(!postpriceBizHandler.calcOrderPostprice())
                {
                    Thread.sleep(10000);
                }
                else
            ...
            if(succ==false)
            {
                ...
                resultInfo.setErrorMsg("正在进行定时运费计算，请稍后重试。");
            }
        ...
        catch (Exception exp)
        {
            ...
            logger.info("end manual post price calc");
        }
    }
