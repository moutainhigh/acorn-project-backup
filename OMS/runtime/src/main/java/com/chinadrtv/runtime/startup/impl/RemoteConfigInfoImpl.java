...
//import com.chinadrtv.configcenter.common.facade.ConfigurationQueryFacade;
//import com.chinadrtv.configcenter.common.facade.bean.ConfigCenter;
//import com.chinadrtv.configcenter.common.facade.bean.RspObj;
//import com.chinadrtv.configcenter.common.facade.code.RspCode;
...
public class RemoteConfigInfoImpl implements StartUpExecuter {

    Logger logger = LoggerFactory.getLogger("LOG_TYPE.PAFF_COMMON.val");

    //项目名称(从属性文件读取)
    private final String PROJECT_NAME = "configCenter.project.name";
    //环境参数(从属性文件读取)
    private final String PROJECT_ENVIRONMENT = "configCenter.project.env";
    //配置中心WebService地址(从属性文件读取)
    private final String CONFIG_CENTER_ADDRESS = "configCenter.address";
...
//                    ApplicationContextConfig.put(c.getConfigKey(), c.getConfigValue());
//                }
//            }
//        } else {
//            StringBuffer sb = new StringBuffer();
