...
public interface PromotionEngineService {
	 ...
	 * @return
	 */
//	public List<Promotion> getAvailablePromotions(PreTrade preTrade, Integer clacRound) throws Exception;
...
//	public List<PromotionRuleResult> getPromotionResult(PreTrade preTrade, Map context, Integer clacRound) throws Exception;
	 ...
	 * @param ruleId
	 */
//	public void ruleChanged(Long ruleId) throws Exception;
