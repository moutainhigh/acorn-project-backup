 ...
 */
@Repository("com.chinadrtv.erp.tc.core.dao.hibernate.PluSplitDaoImpl")
public class PluSplitDaoImpl extends GenericDaoHibernateBase<PlubasInfo, Long> implements PluSplitDao {
