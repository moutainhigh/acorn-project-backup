...
public class DateTimeUtil {
	...
	public static SimpleDateFormat sim3 = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss");
	public static SimpleDateFormat sim4 = new SimpleDateFormat("yyyy-MM-dd HH");
	public static SimpleDateFormat sim5 = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss ss");
	public static SimpleDateFormat sim6 = new SimpleDateFormat("yyyy-MM-dd");
