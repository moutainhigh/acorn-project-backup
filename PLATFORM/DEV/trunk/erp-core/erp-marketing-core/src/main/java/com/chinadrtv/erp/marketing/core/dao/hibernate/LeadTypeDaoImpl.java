 ...
 * 
 * <dl>
 * <dt><b>Title:线索类型DAO实现</b></dt>
 * <dd>
 * none</dd>
 * <dt><b>Description:线索类型DAO实现</b></dt>
 * <dd>
 * <p>
 * none</dd>
 * </dl>
 ...
 */
@Repository
public class LeadTypeDaoImpl extends
		GenericDaoHibernate<LeadType, java.lang.Long> implements Serializable,
		LeadTypeDao {
	...
	public LeadTypeDaoImpl() {
		super(LeadType.class);
	}
	...
	public List<LeadType> query(CampaignDto Campaign, DataGridModel dataModel) {
		StringBuffer sql = new StringBuffer("from LeadType o where 1=1 ");
		...
		List<LeadType> objList = findPageList(sql.toString(), params);
		return objList;
	}
	...
	public Integer queryCount(CampaignDto Campaign) {
		StringBuffer sql = new StringBuffer(
				"select count(o.id) from LeadType o where 1=1 ");
	...
	public List<LeadType> queryList(String... type) {
		String hql = "from LeadType where type in (";
		int i=0;
		for(String t :type){
			if(i>0){
				hql+=",";
		...
		List<LeadType> list = findList(hql);
		return list;
	}
