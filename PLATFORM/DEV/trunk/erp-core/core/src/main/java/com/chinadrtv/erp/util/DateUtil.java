...
public class DateUtil {
	...
	public static java.util.Date string2Date(String dateTime, String dateFormat)
			throws SQLException {
		try {
            if(StringUtil.isNullOrBank(dateTime)) return null;
			SimpleDateFormat customDateFormat = new SimpleDateFormat(dateFormat);
...
//		 long diffHours = diff / (60 * 60 * 1000);
    ...
    public static final long getDateDeviations(Date sdate,Date edate) {
...
//		 long diffHours = diff / (60 * 60 * 1000);
     ...
     * @date 2013-3-28 下午8:19:59
     */
    public static final long getDateDeviations_second(Date sdate, Date edate) {
           if(sdate == null || edate == null) return 0L;
                                            //   String format) {
//        if (format == null)
//            format = "yyyy-MM-dd HH:mm:ss";
//        SimpleDateFormat formatt = new SimpleDateFormat(format);
