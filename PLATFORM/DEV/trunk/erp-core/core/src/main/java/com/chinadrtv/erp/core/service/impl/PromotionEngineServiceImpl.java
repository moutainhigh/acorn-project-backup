...
public class PromotionEngineServiceImpl implements PromotionEngineService {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PromotionEngineServiceImpl.class);
	/**
...
//    private SystemConfigure systemConfigUtil;
    ...
    private String getRuleFromClassPath(String ruleFileName){
        ...
        try {
            ...
            log.error("Error to load rule file: com/chinadrtv/b2c/service/promotion/" + ruleFileName);
        }
        return s;
    }
