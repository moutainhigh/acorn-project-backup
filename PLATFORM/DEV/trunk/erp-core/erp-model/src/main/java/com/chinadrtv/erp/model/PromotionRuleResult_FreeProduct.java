 ...
 */
@Entity
@DiscriminatorValue("FreeProduct")
public class PromotionRuleResult_FreeProduct extends PromotionRuleResult implements Serializable {
    ...
    public PromotionRuleResult_FreeProduct() {

    }

    public PromotionRuleResult_FreeProduct(String resultDescription, String productId, String skuCode,
