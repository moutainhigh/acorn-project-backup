...
*/
@Entity
@Table(name = "ORDERDET_HIST", schema = "IAGENT")
public class OrderdetHist implements java.io.Serializable {

	private static final long serialVersionUID = -6534192243566959227L;
	private Long id;
	...
	/** minimal constructor */
	public OrderdetHist(String orderdetid) {
		this.orderdetid = orderdetid;
	}

	/** full constructor */
	public OrderdetHist(String orderdetid, String orderid, String prodid,
			...
			String cardrightnum, BigDecimal accountingcost, String histcrusr,
			Date histcrdt) {
		this.orderdetid = orderdetid;
	...
	// Property accessors
	@Id
	@SequenceGenerator(name = "SEQORDERDET_HIST", sequenceName="IAGENT.SEQORDERDET_HIST")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQORDERDET_HIST")
	...
	@Column(name = "ORDERDETID", nullable = false, length = 16)
	...
	@Column(name = "UPRICE", precision = 10)
	...
	@Column(name = "UPNUM", precision = 10, scale = 0)
	...
	@Column(name = "SPRICE", precision = 10)
	...
	@Column(name = "SPNUM", precision = 10, scale = 0)
	...
	@Column(name = "BACKMONEY", precision = 22, scale = 0)
	...
	@Column(name = "COMPENSATE", precision = 10)
	...
	@Column(name = "ACCOUNTINGCOST", precision = 10)
