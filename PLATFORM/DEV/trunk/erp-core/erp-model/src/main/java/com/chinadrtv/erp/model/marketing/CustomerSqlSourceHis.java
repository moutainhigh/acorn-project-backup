 ...
 * 
 */
@Table(name = "CUSTOMER_SQLSOUCE_HIS", schema = "ACOAPP_MARKETING")
@Entity
@JsonIdentityInfo(generator = ObjectIdGenerators.IntSequenceGenerator.class, property = "@id")
public class CustomerSqlSourceHis {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "SEQ_CUSTOMER_SQLSOUCE_HIS", sequenceName = "ACOAPP_MARKETING.SEQ_CUSTOMER_SQLSOUCE_HIS")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_CUSTOMER_SQLSOUCE_HIS")
	@Column(name = "ID")
	public Long getId() {
		return id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CustomerSqlSourceHis other = (CustomerSqlSourceHis) obj;
		if (crtDate == null) {
