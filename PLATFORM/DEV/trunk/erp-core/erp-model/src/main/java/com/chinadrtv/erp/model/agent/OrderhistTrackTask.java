 ...
 * 
 */
@javax.persistence.Table(name = "ORDERHIST_TRACK_TASK", schema = "IAGENT")
@Entity
public class OrderhistTrackTask implements Serializable{
    ...
    @SequenceGenerator(name = "SEQ", sequenceName = "IAGENT.SEQ_ORDERHIST_TRACK_TASK")
	public Long getId() {
		return id;
	}
