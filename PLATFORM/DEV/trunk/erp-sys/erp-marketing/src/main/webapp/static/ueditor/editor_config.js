...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:  "http://file.erp.chinadrtv.local/" + "pics"//"http://192.168.3.171/pic"                        //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,imageManagerPath:"http://localhost:8080/" + "pics/"                                    //图片修正地址，同imagePath
        //屏幕截图配置区
        ...
        ,wordImagePath:"http://file.erp.chinadrtv.local/" + "pics"                      //
        ...
        ,initialFrameWidth:"100%"  //初始化编辑器宽度,1000，同时支持百分比，例如："70%"
