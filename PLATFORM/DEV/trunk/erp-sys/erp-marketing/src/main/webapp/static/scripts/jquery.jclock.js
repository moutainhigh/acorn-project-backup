(function($) {
  $.fn.jclock = function(options) {
    ...
    return this.each(function() {
      ...
      $.fn.jclock.utc = o.utc;
       $.fn.jclock.startDate = o.startDate;
       $.fn.jclock.nowDate = $.fn.jclock.startDate!=null ? $.fn.jclock.parseDate($.fn.jclock.startDate): new Date();
      $this.css({
  ...
  $.fn.jclock.startClock = function() {
   ...
   $.fn.jclock.running = true;
      timerID = setInterval("$.fn.jclock.displayTime()",1000);
...
//$.fn.jclock.nowDate.getTime()+1000
  	$.fn.jclock.nowDate.setTime($.fn.jclock.nowDate.getTime()+1000);
  ...
  $.fn.jclock.getDate = function() {
	if($.fn.jclock.withDate == true) {
      ...
      var now = new Date();
      if($.fn.jclock.nowDate!=null){
      	now = $.fn.jclock.nowDate;
      }
      var year, month, date;
 ...
 $.fn.jclock.parseDate = function(startDate){
