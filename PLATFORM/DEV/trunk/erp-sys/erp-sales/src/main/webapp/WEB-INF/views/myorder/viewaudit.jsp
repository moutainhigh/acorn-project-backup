                    ...
                    <table id="oldCartTable" class="pro" width="100%"  border="1" cellspacing="0" cellpadding="0" >
                        ...
                        <c:forEach var="detail" items="${order.orderdets}">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <div title="<c:choose><c:when test="${detail.soldwith eq 1}">直接销售</c:when><c:when test="${detail.soldwith eq 2}">搭销</c:when><c:otherwise>赠品</c:otherwise></c:choose>" class="compare_cell" >
                                    <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach var="change" items="${changeMap}">
                                    ...
                                    <tr>
                                        ...
                                        <td  align="center">
                                            <div title='<c:choose><c:when test="${change.soldwith eq 1}">直接销售</c:when><c:when test="${change.soldwith eq 2}">搭销</c:when><c:otherwise>赠品</c:otherwise></c:choose>' class="compare_cell">
                ...
                <td class="no_r  " valign="top">
                    ...
                    <c:if test="${isContactChanged}">
                        ...
                        <p>
                                ...
                                <span id="span_invalid_address_tip"></span>
                        </p>
                        <p>	
