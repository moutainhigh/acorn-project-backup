...
<html>
<head>
    <%@ include file="/common/inbound_jscss.jsp"%>
    <script type="text/javascript">
        var _contactId = '${contactId}';
        var orderPayTypeList=eval(${orderPayTypes});
        var insureData=eval(${insureList});
        var insureToData=eval(${insureToList});
    </script>
</head>
<body >
				...
				<%----%>
                      ...
                      <div class="receiptInfo">
                          ...
                          <div class="sift" id="addAddressDiv">
                              ...
                              <p>
                                  <label>&nbsp;</label> <input tabindex="11" name="address" id="address" type="text" size="64" class="easyui-validatebox" data-options="required:true" /><span id="show_address_check" class="ml10 red">无效地址</span>
                              </p><p>
                      ...
                      <table id="addCardTable" class="cr_table" border="0" cellspacing="0" cellpadding="0" hidden="hidden">
                       ...
                       <c:if test="${customer.state==null||customer.state==2}">
                                <div class="textC mt10" >
                                    <a tabindex="14" href="javascript:void(0);" ondblclick="javascript:void(0);" id="compareEditPhoneAndAddress" class="phoneNums_btns" style="width:80px" >保存</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <%--<a tabindex="14" href="javascript:void(0);" id="compareEditPhoneAndAddress_hidden" class="phoneNums_btns_dis" style="width:80px;display: none;" >保存</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
