...
<body>
	...
	<script type="text/javascript">
		...
		var curUid = eval('${agentId}');
		var taskPrivilege = eval('${taskPrivilege}');
	</script>
							...
							<tr>
								...
								<td width="25%">
									<div class="datepart" style="display: none;">
										<input size="10" type="text" id="beginDate" value="${beginDate }" class="easyui-datebox" data-options="validType:'querydatevalidator'"  required="true" style="width:95px" />&nbsp;~&nbsp;
										<input size="10" type="text" id="endDate" value="${endDate }" class="easyui-datebox" data-options="validType:'querydatevalidator'"  required="true" style="width:95px" />
									</div>
								</td>
							</tr>
							<tr>
				...
				<div class="baseInfo" style="margin: 0">
					<table class="" border="0" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							...
							<td width="30%">
								<input size="10" type="text" id="beginFlowDate" value="${beginDate }"  class="easyui-datebox" data-options="validType:'querydatevalidator'" style="width:95px"/>&nbsp;~&nbsp;
								<input size="10" type="text" id="endFlowDate" value="${endDate }" class="easyui-datebox" data-options="validType:'querydatevalidator'"  style="width:95px"/>
							</td>
						</tr>
						<tr>
							<td>座席工号</td>
	                ...
	                <div class="baseInfo" style="margin: 0">
	                    <table class="" border="0" cellspacing="0" cellpadding="0" width="100%">
	                        <tr>
	                            ...
	                            <td width="10%">提交审批时间</td>
	                            <td width="30%">
	                                <input size="10" type="text" id="beginFlowDate_add" value="${beginDate }"  class="easyui-datebox"  data-options="validType:'querydatevalidator'" style="width:95px"/>&nbsp;~&nbsp;
	                                <input size="10" type="text" id="endFlowDate_add" value="${endDate }" class="easyui-datebox"  data-options="validType:'querydatevalidator'" style="width:95px"/>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>座席工号</td>
