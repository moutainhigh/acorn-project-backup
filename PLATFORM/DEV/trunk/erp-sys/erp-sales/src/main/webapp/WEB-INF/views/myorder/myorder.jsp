...
<body>
					...
					<table class="" border="0" cellspacing="0" cellpadding="0"
						...
						<tr class="u">
                            ...
                            <td colspan="2"><input style="width:95px" class="easyui-datebox"  data-options="validType:'querydatevalidator'"
                                    ...
                                    style="width:95px" class="easyui-datebox" type="text" id="tbEndCrdt"  data-options="validType:'querydatevalidator'"
						...
						<tr id="morConditons3">
							...
							<td>订单出库时间</td>
							<td ><input style="width:95px" class="easyui-datebox" data-options="validType:'querydatevalidator'"
								type="text" id="tbBeginOutdt" name="beginOutdt">&nbsp;~&nbsp;<input
								style="width:95px" class="easyui-datebox" type="text" id="tbEndOutdt" data-options="validType:'querydatevalidator'"
								name="endOutdt"></td>
					...
					<table class="" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td><input class="easyui-datebox"style="width:100px"
								type="text" id="tbBeginCrdt_pay" name="beginCrdt_pay" data-options="validType:'querydatevalidator'" value="${startDate }">&nbsp;~&nbsp;
                                <input class="easyui-datebox" type="text" id="tbEndCrdt_pay" style="width:100px"  data-options="validType:'querydatevalidator'"
					...
					<table class="" border="0" cellspacing="0" cellpadding="0"
						...
						<tr class="u" id="tr_my_problem_order_last">
							...
							<td><input style="width:95px" class="easyui-datebox" data-options="validType:'querydatevalidator'"
								...
								style="width:95px" class="easyui-datebox" type="text" id="input_problem_tbEndCrdt" data-options="validType:'querydatevalidator'"
						...
						<tr name="tr_problem_morConditons3">
							...
							<td ><input style="width:95px" class="easyui-datebox"
								type="text" id="input_problem_tbBeginOutdt" name="input_problem_beginOutdt" data-options="validType:'querydatevalidator'" >&nbsp;~&nbsp;<input
								style="width:95px" class="easyui-datebox" type="text" id="input_problem_tbEndOutdt" data-options="validType:'querydatevalidator'"
					...
					<table class="" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td><input id="tbCrusr_audit" name="crusr_audit" type="text"   class="easyui-validatebox" data-options="prompt:'输入座席工号', required:true" validType="remote['/myorder/myorder/checkGrpMember','usrId']" invalidMessage="非本主管下的座席工号"
								maxlength="255"  value="${currentUsrId }"/></td>
							<td>订单生成时间</td>
							<td colspan="4"><input style="width:95px" class="easyui-datebox"  data-options="validType:'querydatevalidator'"
								type="text" id="tbBeginCrdt_audit" name="beginCrdt_audit" value="${startDate }">&nbsp;~&nbsp;<input style="width:95px"
								class="easyui-datebox" type="text" id="tbEndCrdt_audit" name="endCrdt_audit" data-options="validType:'querydatevalidator'" value="${endDate }"></td>
					...
					<div class="baseInfo" style="margin: 0">
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							...
							<tr id="reminder_line" >
								...
								<td>订单生成时间</td>
								<td colspan="2">
									<input size="10" type="text" id="r_beginCrDate" name="beginCrDate" class="easyui-datebox" data-options="validType:'querydatevalidator'" value="${startDate }" style="width:95px" />&nbsp;~&nbsp;
									<input size="10" type="text" id="r_endCrDate" name="endCrDate" class="easyui-datebox" data-options="validType:'querydatevalidator'" value="${endDate }" style="width:95px" />
								</td>
                                <td align="left" valign="bottom">
							...
							<tr class="reminer_hidden">
								...
								<td>订单出库时间</td>
								<td colspan="3">
									<input size="10" type="text" id="r_beginRfoutdt" name="beginRfoutdt" class="easyui-datebox" data-options="validType:'querydatevalidator'" style="width:95px" />&nbsp;~&nbsp;
									<input size="10" type="text" id="r_endRfoutdt" name="endRfoutdt" class="easyui-datebox" data-options="validType:'querydatevalidator'" style="width:95px" />
								</td>
							</tr>
							<tr>
                    ...
                    <table class="" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr class="u">
                            ...
                            <td colspan="2"><input style="width:95px" class="easyui-datebox" data-options="validType:'querydatevalidator'" 
                                    ...
                                    style="width:95px" class="easyui-datebox" type="text" id="fo_endDate" data-options="validType:'querydatevalidator'" 
                                    name="endCrdt" value="${endDate }"></td>
                            <td>&nbsp;</td>
                            <td>订单创建人</td>
                            <td align="left" valign="bottom" >
    ...
    <div id="dlgClaim" class="easyui-window" style="padding-top: 20px;"
        ...
        <form id="fmClaim" method="post">
            <table id="detailClaim" class="editTable" style="margin:0 auto 20px">
                <tr>
                    <td><label class="ml10" for="txtClaimOrderId">订单号：</label></td>
                    <td><input id="txtClaimOrderId" class="inputStyle"
                               readonly="readonly" disabled="disabled" name="txtClaimOrderId"></td>

                    <td><label class="ml10" id="txtCardCVVLabel"  for="txtCardCVV">附加码：</label></td>
                    <td><input id="txtCardCVV" class="easyui-validatebox"  name="txtCardCVV"></td>
                </tr>
                <tr>
                    <td><label id="txtClaimCredentialsLabel" class="ml10" for="txtClaimCredentials" >证件号：</label></td>
                    <td><div id="dvClaimCredentials"><input id="txtClaimCredentials" class="easyui-combobox" data-options="required:true" name="txtClaimCredentials" style="width:134px"></div></td>
                    <td><label id="txtClaimPhoneLabel" class="ml10" for="txtClaimPhone">手机号：</label></td>
                    <td><div id="dvClaimPhone"><input id="txtClaimPhone" data-options="required:true,validType:'numbervalidator[\'txtClaimPhone\',11,11]'" style="width:134px" name="txtClaimPhone"></div></td>
                </tr>
            </table>
