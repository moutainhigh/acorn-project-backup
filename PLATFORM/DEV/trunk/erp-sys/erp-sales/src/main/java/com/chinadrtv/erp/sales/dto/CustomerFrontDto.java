...
public class CustomerFrontDto implements Serializable {
    ...
    private String hasinsure; // 1:已有保险;0:没有保险
    private String insureExpire; // 0:保险没有过期;1:已经过期
    ...
    public String getInsureExpire() {
        return insureExpire;
    }

    public void setInsureExpire(String insureExpire) {
        this.insureExpire = insureExpire;
    }
}
