...
public class OrderComparasionDetailServiceImpl implements OrderComparasionDetailService{
    ...
    public static void main(String[] args) {
    	List<UserBpmTask> contactInsts = new ArrayList<UserBpmTask>();
    	UserBpmTask ubt = new UserBpmTask();
    	ubt.setBusiType("1");
    	UserBpmTask ubt2 = new UserBpmTask();
    	ubt2.setBusiType("0");
    	UserBpmTask ubt3 = new UserBpmTask();
    	ubt3.setBusiType("3");
    	UserBpmTask ubt4 = new UserBpmTask();
    	ubt4.setBusiType("2");
    	contactInsts.add(ubt);
    	contactInsts.add(ubt2);
    	contactInsts.add(ubt3);
    	contactInsts.add(ubt4);
		Collections.sort(contactInsts, new Comparator<UserBpmTask>() {
			@Override
			public int compare(UserBpmTask o1,
					UserBpmTask o2) {
		...
		System.out.println(contactInsts);
	}
}
