...
public class ShoppingCartController extends BaseController {
     ...
     * @param response
     */
    @RequestMapping(value = "deleteProduct/{shoppingCartId}/{shoppingCartProductId}", method = RequestMethod.GET)
    public void deleteShoppingCartProduct(@PathVariable("shoppingCartId") Long shoppingCartId,
                                          @PathVariable("shoppingCartProductId") Long shoppingCartProductId, HttpServletResponse response) {
        AgentUser user = SecurityHelper.getLoginUser();
    ...
    public void addShoppingCartProduct(Long shoppingCartId, ShoppingCartProduct shoppingCartProduct, HttpServletResponse response) {
        AgentUser user = SecurityHelper.getLoginUser();
        Map<String, String> map = new HashMap<String, String>();
        try {
    ...
    public void addShoppingCartProduct(Long shoppingCartId, String ncCode, String ncFreeName, ShoppingCartProduct shoppingCartProduct,
                                       HttpServletResponse response) {
        AgentUser user = SecurityHelper.getLoginUser();
        Map<String, String> map = new HashMap<String, String>();
        try {
    ...
    public void updateShoppingCartProduct(ShoppingCartProduct shoppingCartProduct, HttpServletResponse response) {
        AgentUser user = SecurityHelper.getLoginUser();
        Map<String, String> map = new HashMap<String, String>();
        try {
            if (StringUtils.isNotBlank(shoppingCartProduct.getProductType()) && shoppingCartProduct.getProductType().contains("%")) {
    ...
    public void getOrderMessage(Long shoppingCartId, Order pageOrder, String addressId, HttpServletResponse response) {
        ...
        try {
            ...
            this.setOrderValue(pageOrder, addressId, order, null);
    ...
    public void createOrder(Long shoppingCartId, Order pageOrder, String addressId, BigDecimal freight, Long leadId, String extraCode, HttpServletResponse response) {
        AgentUser user = SecurityHelper.getLoginUser();
        Map<String, String> map = new HashMap<String, String>();
        try {
            Order order = shoppingCartService.createOrderbyShoppingCart(shoppingCartId, user.getUserId(), user.getDefGrp());

            if (order != null && leadId != null) {
                ...
                this.setOrderValue(pageOrder, addressId, order, extraCode);
    ...
    private void setOrderValue(Order pageOrder, String addressId, Order order, String extraCode) throws ServiceException {
    ...
    public void validateShoppingCart(@PathVariable("shoppingCartId") Long shoppingCartId, HttpServletResponse response) {
        String message = null;
        try {
            AgentUser user = SecurityHelper.getLoginUser();
