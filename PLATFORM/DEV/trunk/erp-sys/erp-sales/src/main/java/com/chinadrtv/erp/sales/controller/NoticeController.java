...
public class NoticeController extends BaseController {
    ...
    @ResponseBody
    public void save(Cusnote cusnote) {
    ...
    @ResponseBody
    public void update(Cusnote cusnote) {
        CusnoteId cusnoteId = new CusnoteId();
        cusnoteId.setFeatstr(cusnote.getFeatstr());
        cusnoteId.setOrderid(cusnote.getOrderid());
        ...
        result.setRenote(cusnote.getRenote());
