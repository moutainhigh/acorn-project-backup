...
<form:form commandName="promotion" method="post" action="/admin/promotion" id="promotionForm"
    ...
    <!--  
        ...
        <input id="channel"  disable="true" name="channel" value="${promotion.channel.id}" class="easyui-combobox" data-options="valueField: 'id',textField: 'name'" style="width:200px" />
            </td>
    ...
    <div id="toolbar">
       ...
       <!--  
		...
		<div class="easyui-layout" data-options="fit:true">
		      <div data-options="region:'west'"   title='<c:if test="${promRuleID == 2}" >赠品</c:if><c:if test="${promRuleID == 9}" >搭品</c:if>' style="width:170px">  
            ...
            <div data-options="region:'center'" style="width:330px;padding:0px">  
              ...
              <div data-options="region:'east'"  title="限制产品" style="width:170px;">  
