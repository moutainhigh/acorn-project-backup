    ...
    <div>
        ...
        <div class="loginc pb_10">
            <form method="post" id="loginForm" action="<c:url value='/j_security_check'/>" onsubmit="saveUsername(this);return validateForm(this)">
                ...
                <p><label  for="j_password" >密码:</label> <input type="password" class="w_120" name="j_password" id="j_password" value="${pwd }" tabindex="2"/><span class="F_red"> *</span></p>
