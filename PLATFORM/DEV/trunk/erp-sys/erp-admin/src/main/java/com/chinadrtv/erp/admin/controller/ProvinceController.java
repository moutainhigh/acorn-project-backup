...
import com.chinadrtv.erp.admin.model.Province;
import com.chinadrtv.erp.admin.service.ProvinceService;
...
public class ProvinceController extends BaseController {
    ...
    @RequestMapping(value = "/admin/province/load", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/admin/province/lookup", method = RequestMethod.POST)
