...
import com.chinadrtv.erp.service.core.constant.TaskProcessStatus;
...
public class IndexController extends BaseController {
	...
	private static String TSRTASKTYPE = "TSRTASKTYPE";
...
//        mav.addObject("phoneList", result.get("rows"));
    ...
    @RequestMapping("/event/myevent")
    public String myevent() throws Exception {
        return "event/myevent";
    }
    @RequestMapping("/event/eventmanage")
    public String eventmanage() throws Exception {
        return "event/eventmanage";
    }
    @RequestMapping("/task/taskAllocation")
    public ModelAndView taskAllocation() throws Exception {
		ModelAndView mav = new ModelAndView("task/taskAllocation");
		List<Names> names = namesService.getAllNames(TSRTASKTYPE);
		mav.addObject("taskStatus", TaskProcessStatus.toList());
		mav.addObject("taskType",names);
		return mav;
    }
    @RequestMapping("/task/customertask1")
    public String customertask1() throws Exception {
        return "task/customertask1";
    }
    @RequestMapping("/task/customertask2")
    public String customertask2() throws Exception {
        return "task/customertask2";
    }
