...
function addressInit(instId, pv, citv, countv, av) {
	...
	$("#countyId"+instId).combobox({
		...
		onLoadSuccess:function(){
		 if(countv)	$("#countyId"+instId).combobox('setValue', countv);
			//countv='';
		}
	});
    ...
    if(countv){
        $("#areaId"+instId).combobox({
            ...
            onLoadSuccess:function(){
                if(av)$("#areaId"+instId).combobox('setValue', av);
                av='';
                pv='';
                citv='';
                countv='';
...
<input class="easyui-combobox" id="province${instId}"  class="province" name="province${instId}"  data-options="required:true,validType:'address_p[\'#province${instId}\']'" style="width:100px;" /> &nbsp;
<input class="easyui-combobox" id="cityId${instId}"  class="cityId" name="cityId${instId}"  data-options="formatter:formatItemCity,required:true,validType:'address_c[\'#cityId${instId}\']'"/>&nbsp;
<input class="easyui-combobox" id="countyId${instId}"  class="countyId" name="countyId${instId}"  data-options="formatter:formatItemCounty,required:true,validType:'address_t[\'#countyId${instId}\']'"/>&nbsp;
<input class="easyui-combobox" id="areaId${instId}"  class="areaId" name="areaId${instId}" data-options="required:true,validType:'address_a[\'#areaId${instId}\']'"/>