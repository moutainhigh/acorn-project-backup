...
//                 .css('margin-right','55px');
             ...
             if(phone.customerId.length>1){
                 console.info("ssssssssssssss"+phone.customerId);
                 createRecommendTask(phone.dnsi,phone.ani,phone.customerId,phone.customerType,phone.leadId);
                 gotoInfoCustomer(phone.customerId,phone.customerType,phoneNoMask(phone.ani),false);

             }else{
                 console.info("ssssssssssssss_2"+phone.customerId);
                 //根据呼入号码查询客户
