            ...
            <table class="" border="0" cellspacing="0" cellpadding="0"
                ...
                <tr>
                    ...
                    <td colspan="5"><input size="10" type="text" id="gendate_begin"
                                           style="width: 150px" class="easyui-datetimebox" data-options="required:true"/>&nbsp;~&nbsp; <input
                            size="10" type="text" id="gendate_end" style="width: 150px"
                ...
                <tr>
                    ...
                    <td colspan="5"><input size="10" type="text" id="redate_begin"
                        ...
                        <input
                                size="10" type="text" id="redate_end" style="width: 150px"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <c:choose>
                            <c:when test="${isDepartmentManager==false}">
                            ...
                            <c:when test="${isDepartmentManager==true}">
