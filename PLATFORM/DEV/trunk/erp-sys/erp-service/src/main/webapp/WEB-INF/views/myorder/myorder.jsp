...
<body>
    ...
    <script type="text/javascript" src="${ctx}/static/js/invoice/invoice.js?${rnd}"></script>
    <script type="text/javascript" src="${ctx}/static/js/backorder/backorder.js?${rnd}"></script>
	...
	<div id="myorder_tabs" class="easyui-tabs" style="height: auto">
					...
					<table class="" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td><input id="tbContactname" name="contactname" type="text"
								maxlength="255" /></td>
							<td>座席工号</td>
							<td><input id="tbCrusr" name="crusr" type="text" class="easyui-validatebox"  data-options="prompt:'输入座席工号', required:true"  validType="remote['/myorder/myorder/checkGrpMember','usrId']" invalidMessage="非本主管下的座席工号"
					...
					<table class="" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td><input id="tbContactname_pay" name="contactname_pay"
								type="text" maxlength="255" /></td>
							<td>订单生成时间</td>
							<td><input class="easyui-datebox"style="width:100px"  data-options="validType:'querydatevalidator'"
		...
		<%--</c:if>--%>
        <div title="发票申请查询">
            <form id="invoice_form" class="tabs-form" action="" method="post">
                ...
                <div class="baseInfo" style="margin: 0">
                    <table class="" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            <td>订单编号</td>
                            <td ><input id="orderid_invoice" name="orderid_invoice"
                                        type="text" value="" maxlength="255" /></td>

                            <td>发票生成时间</td>
                            <td><input style="width:95px" class="easyui-datebox"  data-options="validType:'querydatevalidator'"
                                       type="text" id="tbBeginCrdt_invoice" name="tbBeginCrdt_invoice" value="${startInvoiceDate }">&nbsp;~&nbsp;<input
                                    style="width:95px" class="easyui-datebox" type="text" id="tbEndCrdt_invoice" data-options="validType:'querydatevalidator'"
                                    name="tbEndCrdt_invoice" value="${endDate }"></td>

                            <td>状态</td>
                            <td><select id="tbStatus_invoice" name="status_invoice" class="easyui-combobox" style="width:134px">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td colspan="2"><div class="submitBtns" >
                                <a href="javascript:void(0);" id="invoice_query">查询</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="javascript:void(0);" id="invoice_export">数据导出</a>
                            </div> </td>
                        </tr>
                    </table>
            ...
            <div class="history tabs-form">
                <table id="invoiceSubmit_table" style="height: 350px">
                    <thead>
                    </thead>
                </table>
            </div>
        ...
        <div title="压单订单查询">
            <form id="omsbackorder_form" class="tabs-form" action="" method="post">
                ...
                <div class="baseInfo" style="margin: 0">
                    <table class="" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            <td>订单编号</td>
                            <td ><input id="omsbackorder_orderid" name="txt_omsbackorder_orderid"
                                        type="text" value="" maxlength="255" /></td>

                            <%--<td>包裹单号</td>
                            <td><input id="" name="input_problem_mailid" type="text"
                                       maxlength="255" /></td>--%>
                            <td></td>
                            <td colspan="2"><div class="submitBtns" >
                                <a href="javascript:void(0);" id="omsbackorder_query">查询</a>
                            </div></td>
                        </tr>
                        <%--<tr>--%>
                            <%--<td></td>--%>
                            ...
                            <%--<td></td>--%>
                            <%--<td colspan="2"><div class="submitBtns" >--%>
                                <%--<a href="javascript:void(0);" id="">查询</a>--%>
                            <%--</div></td>--%>
                        <%--</tr>--%>
                    </table>
            ...
            <div class="receiptInfo tabs-form withtool">
                <table id="omsbackorder_table" cellspacing="0" cellpadding="0"<%--style="height: 350px"--%>>
                    <%--<thead>
                    </thead>--%>
                </table>
            </div>
