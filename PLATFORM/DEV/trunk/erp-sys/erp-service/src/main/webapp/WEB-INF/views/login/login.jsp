    ...
    <div id="login_wrapper">
        <div id="right_side">
            <div id="login_component">
                ...
                <div id="loginwidget">
                    <form name="login" method="post" autocomplete="off" novalidate="novalidate" onsubmit="beforeSubmit();return validateForm(this);" action="<c:url value='/j_security_check'/>"
                          target="_top" >
