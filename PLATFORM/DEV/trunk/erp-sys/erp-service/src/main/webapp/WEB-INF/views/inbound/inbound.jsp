...
<head>
    ...
    <script type="text/javascript">
        ...
        var orderSaleTypeList=eval(${orderSaleTypes});
        var insureData=eval(${insureList});
        var insureToData=eval(${insureToList});
        var parentOrderId=eval(${parentOrderId});
    </script>
</head>
<body >
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="90%" style="margin: 0 auto">
                      ...
                      <tr>
                        ...
                        <div id="token">
                            ...
                            <a href="javascript:void(0);" id="" onclick="javascript:cgotoEvent('${customer.customerId}');"  style="padding:2px 20px">事件管理</a>&nbsp;&nbsp;&nbsp;&nbsp;
