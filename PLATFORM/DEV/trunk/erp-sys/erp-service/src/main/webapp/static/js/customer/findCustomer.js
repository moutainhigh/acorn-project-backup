...
//跳转到客户详细页面    订单栏
function gotoInfoCustomerOrderTab(customerId,customerType,name,isColseable){
    var url = "/contact/"+customerType+"/"+customerId+"?provid="+ $('#d_provid').val()+"&cityid="+$('#d_cityid').val()+"&selectedTab="+1;
    var tabName = name+"-详细信息";
    var multiTab = false;
    addTab(customerId,tabName,multiTab,url,null,isColseable);
    $('#d_provid').val("");
