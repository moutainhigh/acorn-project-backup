...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/js/common.js${rnd}"></script>
            ...
            <tr>
                ...
                <td style="height:52px;">
                    <div style="color:#fff;font-size:22px;font-weight:bold;">
                        <span style="color:#fff;font-size:22px;font-weight:bold;text-decoration:none">话务分配管理系统
                            <%--<span>(版本号：<spring:message code="systemTemps"/>)</span>--%>
                        </span>
                    </div>
                    <div style="color:#fff">
                        <span style="color:#fff;text-decoration:none">System helps you build your order easily!</span>
                    </div>
                </td>
...
//                $('#main-layout').layout('collapse','east');
        ...
        <div id="main-layout" class="easyui-layout" fit="true"  style="height:550px;" >
            <%--<div region="west" title="" data-options="tools:'#west-tools',collapsible:false,border:false" split="true" style="width:300px;">--%>
            ...
            <%--</div>--%>
            <div style="height:21px;" data-options="region:'south',border:false" >
                <jsp:include page="/common/footer.jsp"/>
            </div>
            <div region="center" href="/index" split="true" border="false">
...
<div id="west-tools">
	<sec:authorize access="hasAnyRole('INBOUND_MANAGER,OUTBOUND_MANAGER')">
