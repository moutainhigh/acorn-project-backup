...
<div id="head">
    ...
    <table class="appHeadBg" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <div class="logo" id="logo">橡果销售管理系统
                    <!--
                ...
                <div id="softphoneWrap" class="softphoneWrap"><a id="softphone" title="拨号" class="softphone" href="#"><span></span></a>
                    <ul class="key_panel">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="c_combo throughconnect" title="转接" style="width:55px;margin: 0 4px"><a id=""></a></div>
                            <div class="c_combo threewaycalling" title="三方通话" style="width:55px;float: right"><a id=""></a></div></li>
                        <li style="margin: 0">
                    ...
                    <ul style="width: 111px" class="c_comboList">
                        ...
                        <li class="leave">
                            ...
                            <dl>
                                ...
                                <dd><label><img src='/static/images/ch.png'/>申请外出</label></dd>
                                <dd><label><img src='/static/images/ch.png'/>主管找</label></dd>
                                <dd><label><img src='/static/images/ch.png'/>下线学习</label></dd>
                                <dd><label><img src='/static/images/ch.png'/>听录音</label></dd>
                                <dd><label><img src='/static/images/ch.png'/>帮别人处理线</label></dd>
                            </dl>
                        </li>
