...
dsy.add("0",
		[ "北京", "上海", "天津", "重庆", "广东", "广西", "贵州", "海南", "河北", "河南", "黑龙江",
				"湖北", "湖南", "吉林", "江苏", "江西", "辽宁", "内蒙古", "宁夏", "青海", "山东",
				"山西", "陕西", "上海", "四川", "天津", "西藏", "新疆", "云南", "浙江", "甘肃",
				"安徽", "福建" ]);

dsy.add("0_0", [ "北京" ]);

dsy.add("0_0_0", [ "北京市", "东城区", "西城区", "宣武区", "房山区", "崇文区", "海淀区", "朝阳区",
		"丰台区", "门头沟区", "石景山区", "通州区", "顺义区", "昌平区", "大兴区", "怀柔区", "平谷区", "密云县",
		"延庆县" ]);

dsy.add("0_1", [ "上海" ]);

dsy.add("0_1_0", [ "黄浦区", "卢湾区", "静安区", "徐汇区", "虹口区", "长宁路", "普陀区", "闸北区",
		"杨浦区", "浦东新区", "宝山区", "嘉定区", "闵行区", "松江区", "青浦区", "南汇区", "奉贤区", "金山区",
		"崇明县" ]);

dsy.add("0_2", [ "天津" ]);

dsy.add("0_2_0", [ "城口县", "大足县", "垫江县", "丰都县", "奉节县", "合川市", "江津市", "开县",
...
dsy.add("0_3_0", [ "城口县", "大足县", "垫江县", "丰都县", "奉节县", "合川市", "江津市", "开县",
		"梁平县", "南川市", "彭水苗族土家族自治县", "荣昌县", "石柱土家族自治县", "铜梁县", "巫山县", "巫溪县",
		"武隆县", "秀山土家族苗族自治县", "永川市", "酉阳土家族苗族自治县", "云阳县", "忠县", "重庆市", "潼南县",
		"璧山县", "綦江县" ]);
...
dsy.add("0_8_6", [ "昌黎县", "卢龙县", "秦皇岛市", "青龙满族自治县" ]);
...
dsy.add("0_11", [ "武汉", "恩施土家族苗族自治州", "黄冈", "黄石", "荆门", "荆州", "潜江", "神农架林区",
		"十堰", "随州", "天门", "鄂州", "仙桃", "咸宁", "襄樊", "孝感", "宜昌" ]);

dsy.add("0_11_0", [ "江汉区", "江岸区", "桥口区", "汉阳区", "武昌区", "青山区", "洪山区", "东西湖区",
		"江夏区", "新洲区", "黄陂区", "汉南区", "蔡甸区" ]);
...
dsy.add("0_30", [ "白银", "定西", "甘南藏族自治州", "嘉峪关", "金昌", "酒泉", "兰州", "临夏回族自治州",
		"陇南", "平凉", "庆阳", "天水", "武威", "张掖" ]);

dsy.add("0_30_0", [ "白银市", "会宁县", "景泰县", "靖远县" ]);

dsy.add("0_30_1", [ "定西县", "临洮县", "陇西县", "通渭县", "渭源县", "漳县", "岷县" ]);

dsy.add("0_30_2", [ "迭部县", "合作市", "临潭县", "碌曲县", "玛曲县", "夏河县", "舟曲县", "卓尼县" ]);

dsy.add("0_30_3", [ "嘉峪关市" ]);

dsy.add("0_30_4", [ "金昌市", "永昌县" ]);

dsy.add("0_30_5",
		[ "阿克塞哈萨克族自治县", "安西县", "敦煌市", "金塔县", "酒泉市", "肃北蒙古族自治县", "玉门市" ]);

dsy.add("0_30_6", [ "皋兰县", "兰州市", "永登县", "榆中县" ]);

dsy.add("0_30_7", [ "东乡族自治县", "广河县", "和政县", "积石山保安族东乡族撒拉族自治县", "康乐县", "临夏市",
		"临夏县", "永靖县" ]);

dsy.add("0_30_8", [ "成县", "徽县", "康县", "礼县", "两当县", "文县", "武都县", "西和县", "宕昌县" ]);

dsy.add("0_30_9", [ "崇信县", "华亭县", "静宁县", "灵台县", "平凉市", "庄浪县", "泾川县" ]);

dsy.add("0_30_10", [ "合水县", "华池县", "环县", "宁县", "庆城县", "庆阳市", "镇原县", "正宁县" ]);

dsy.add("0_30_11", [ "甘谷县", "秦安县", "清水县", "天水市", "武山县", "张家川回族自治县" ]);

dsy.add("0_30_12", [ "古浪县", "民勤县", "天祝藏族自治县", "武威市" ]);

dsy.add("0_30_13", [ "高台县", "临泽县", "民乐县", "山丹县", "肃南裕固族自治县", "张掖市" ]);

dsy.add("0_31", [ "安庆", "蚌埠", "巢湖", "池州", "滁州", "阜阳", "合肥", "淮北", "淮南", "黄山",
		"六安", "马鞍山", "宿州", "铜陵", "芜湖", "宣城", "亳州" ]);

dsy.add("0_31_0", [ "安庆市", "怀宁县", "潜山县", "宿松县", "太湖县", "桐城市", "望江县", "岳西县",
		"枞阳县" ]);

dsy.add("0_31_1", [ "蚌埠市", "固镇县", "怀远县", "五河县" ]);

dsy.add("0_31_2", [ "巢湖市", "含山县", "和县", "庐江县", "无为县" ]);

dsy.add("0_31_3", [ "池州市", "东至县", "青阳县", "石台县" ]);

dsy.add("0_31_4", [ "滁州市", "定远县", "凤阳县", "来安县", "明光市", "全椒县", "天长市" ]);

dsy.add("0_31_5", [ "阜南县", "阜阳市", "界首市", "临泉县", "太和县", "颖上县" ]);

dsy.add("0_31_6", [ "长丰县", "肥东县", "肥西县" ]);

dsy.add("0_31_7", [ "淮北市", "濉溪县" ]);

dsy.add("0_31_8", [ "凤台县", "淮南市" ]);

dsy.add("0_31_9", [ "黄山市", "祁门县", "休宁县", "歙县", "黟县" ]);

dsy.add("0_31_10", [ "霍邱县", "霍山县", "金寨县", "六安市", "寿县", "舒城县" ]);

dsy.add("0_31_11", [ "当涂县", "马鞍山市" ]);

dsy.add("0_31_12", [ "灵璧县", "宿州市", "萧县", "泗县", "砀山县" ]);

dsy.add("0_31_13", [ "铜陵市", "铜陵县" ]);

dsy.add("0_31_14", [ "繁昌县", "南陵县", "芜湖市", "芜湖县" ]);

dsy.add("0_31_15", [ "广德县", "绩溪县", "郎溪县", "宁国市", "宣城市", "泾县", "旌德县" ]);

dsy.add("0_31_16", [ "利辛县", "蒙城县", "涡阳县", "亳州市" ]);

dsy.add("0_32", [ "福州", "龙岩", "南平", "宁德", "莆田", "泉州", "三明", "厦门", "漳州" ]);

dsy.add("0_32_0", [ "长乐市", "福清市", "福州市", "连江县", "罗源县", "闽侯县", "闽清县", "平潭县",
		"永泰县" ]);

dsy.add("0_32_1", [ "长汀县", "连城县", "龙岩市", "上杭县", "武平县", "永定县", "漳平市" ]);

dsy.add("0_32_2", [ "光泽县", "建阳市", "建瓯市", "南平市", "浦城县", "邵武市", "顺昌县", "松溪县",
		"武夷山市", "政和县" ]);

dsy.add("0_32_3", [ "福安市", "福鼎市", "古田县", "宁德市", "屏南县", "寿宁县", "霞浦县", "周宁县",
		"柘荣县" ]);

dsy.add("0_32_4", [ "莆田市", "仙游县" ]);

dsy.add("0_32_5", [ "安溪县", "德化县", "惠安县", "金门县", "晋江市", "南安市", "泉州市", "石狮市",
		"永春县" ]);

dsy.add("0_32_6", [ "大田县", "建宁县", "将乐县", "明溪县", "宁化县", "清流县", "三明市", "沙县",
		"泰宁县", "永安市", "尤溪县" ]);

dsy.add("0_32_7", [ "厦门市" ]);

dsy.add("0_32_8", [ "长泰县", "东山县", "华安县", "龙海市", "南靖县", "平和县", "云霄县", "漳浦县",
		"漳州市", "诏安县" ]);
