...
function PCAS() {
	...
	this.SelP.onchange = function() {
		document.getElementById("s1").value=document.getElementById("province3").value;
		PCAS.SetC(this.PCA)
	};
	...
	if (this.SelA) {
		this.SelC.onchange = function() {
			document.getElementById("s2").value=document.getElementById("city3").value;
			PCAS.SetA(this.PCA)
		};
		this.SelA.onchange = function() {
			document.getElementById("s3").value=document.getElementById("area3").value;
			PCAS.SetA(this.PCA)
		};
		}
	PCAS.SetP(this)
