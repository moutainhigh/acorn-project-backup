                ...
                <div id="softphoneWrap" class="softphoneWrap"><a id="softphone" title="拨号" class="softphone" href="#"><span></span></a>
                    <ul class="key_panel">
                        ...
                        <li class="clearfix">
                            ...
                            <div id="div_transferPhone" class="c_combo throughconnect"
                                 style="width:55px;margin: 0 4px">
                                <a id="transferPhoneBtn" class="icon" title="转接到客服中心"></a>
                            </div>
            ...
            <td width="123px">
                <div id="state" class="c_combo">
                    ...
                    <ul style="width: 111px" class="c_comboList">
                        ...
                        <li class="readyout"><span class="blue"></span>就绪(可外呼)</li>
                        <li class="hold"><span class="green"></span>保持</li>
                        <li class="mute"><span class="red"></span>静音</li>
                        <li class="unmute"><span class="yel"></span>取消静音</li>
                        <li class="leave">

                            <dl>
                                <dt><label><span class="yel"></span>离席</label><span class="ar fr"></span></dt>
                                ...
                                <dd value="1204"><label><img src='/static/images/ch.png'/>休息</label></dd>
                                <dd value="1205"><label><img src='/static/images/ch.png'/>用餐</label></dd>
                                <dd value="1206"><label><img src='/static/images/ch.png'/>主管沟通</label></dd>
                                <dd value="1207"><label><img src='/static/images/ch.png'/>下线/学习</label></dd>
                                <dd value="1208"><label><img src='/static/images/ch.png'/>开会/培训</label></dd>
                            </dl>
                        </li>
