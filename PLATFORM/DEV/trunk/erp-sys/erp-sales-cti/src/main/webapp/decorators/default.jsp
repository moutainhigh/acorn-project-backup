    ...
    <div class="mt10">
     ...
     <div id="d_selectTask" class=""  style="display:none">
        <!--
         ...
         <div class="clearfix" id="v_selcontact">
             ...
             <input id="d_seat" class=" easyui-combobox" name="d_seat"  data-options="formatter:formatItemSeat"   style="width:100px;height: 22px"/>   </div>
             <!--
...
<div id="w_outphone" class="easyui-window" title="电话呼出" data-options="collapsible:false,minimizable:false,maximizable:false,resizable:false,modal:true,closed:true,draggable:false" style="width:500px;">
    <div style="padding:10px;">
        <table>
    ...
    <p class="winBtnsBar textC">
        <a class="window_btn"  data-options="iconCls:'icon-ok'" href="javascript:void(0)" onclick="javascript:w_outPhoneCall()">确定</a>
    </p>
