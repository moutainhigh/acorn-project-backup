        ...
        <div class="order_info_body">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="phoneNums-title" style="width:auto">
                                <input id="id_address_desc_hide"type="hidden"/>
                                <input  id="id_address_desc" type="text" size="80" class="easyui-validatebox"
                                    data-options="required:true"/><span id="cart_address_desc_check" class="ml10 red">无效地址</span></div>
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="id_shoppingCart_creditCards"  style="display: none" >
                <div class="creditCards">
                    ...
                    <div class="grid-footer" style="display: none">  <label>录入信用卡附加码</label> &nbsp;
