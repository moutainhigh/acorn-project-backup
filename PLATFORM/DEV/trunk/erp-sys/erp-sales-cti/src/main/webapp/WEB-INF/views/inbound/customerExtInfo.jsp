...
<div title="客户扩展信息">
    ...
    <div id="contact_ext" class="easyui-tabs" style=" height:auto">
        <div  title="扩展历史">
            <div class="l_i_h ">
                ...
                <div class="extendInfo tabs-form ">
                    <form name="insure_form" id="contact_insure_form" method="post">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>客户编号</td>
                                <td><input  id="contact_insure_id" type="text" class="" readonly="readonly" <c:if test="${customer.customerType!='2'}">value=${customer.customerId}</c:if> /></td>

                            </tr>
                            <tr>
                                <td colspan="2"><label class="mr10"><input name="isok" id="contact_isok" type="checkbox" <c:if test="${customer.customerType=='2'}"> disabled="disabled" </c:if><c:if test="${customer.insureAge=='-1'}">checked="checked"</c:if> />客户年龄在18-70岁</label>
                                    <label><input name="insure" id="contact_insure" type="checkbox" <c:if test="${customer.customerType=='2'}"> disabled="disabled" </c:if> <c:if test="${customer.insureStatus=='-1'}"> checked="checked" </c:if> />该客户需要保险产品</label></td>
