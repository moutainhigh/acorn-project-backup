		...
		<DIV ID="toolbar">
			<TABLE CELLSPACING="1px" CELLPADDING="1px" WIDTH="100%" CLASS="birtviewer_toolbar">
				...
				<TR>
					...
					<%if( "true".equals(ParameterAccessor.getParameter(request, "__showToc")) ){%>
						<TD WIDTH="6px"/>				
						<TD WIDTH="15px">
					...
					<%if( "true".equals(ParameterAccessor.getParameter(request, "__showParameter")) ){%>
						<TD WIDTH="6px"/>
						<TD WIDTH="15px">
					...
					<%if( "true".equals(ParameterAccessor.getParameter(request, "__showExport")) ){%>
						<TD WIDTH="6px"/>
						<TD WIDTH="15px">
					...
					<%if( !"false".equals(ParameterAccessor.getParameter(request, "__showExportReport")) ){%>
						<TD WIDTH="6px"/>
						<TD WIDTH="15px">
					...
					<%if( !"false".equals(ParameterAccessor.getParameter(request, "__showPrint")) ){%>
						<TD WIDTH="6px"/>
						<TD WIDTH="15px">
