        ...
        <div class="order_info_body">
            ...
            <div id="all_address_info">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="newCD" style="width:100%;display: none;background: #fafafa;"id="id_address_phone_edit_table">
                    ...
                    <tr>
                        <td></td>
                        <td><div  class="phoneNums-title" style="width:auto"><input id="id_address_desc" type="text" size="80" class="easyui-validatebox" data-options="required:true"   /></div></td>
                    </tr>
                    <tr>
            ...
            <div id="id_shoppingCart_creditCards"  style="display: none" >
                <div class="creditCards">
                    ...
                    <div class="grid-footer">  <label>录入信用卡附加码</label> &nbsp;
                        <input id="tbExtraCode" type="text" maxlength="255" name="extraCode">&nbsp;<span class="red">*</span></div>
                </div>
...
<div id="subOrder_COD" title="送货确认" class="easyui-window popWin"  data-options="modal:true,shadow:false,collapsible:false,minimizable:false,maximizable:false,resizable:false,closed:true,draggable:false" >
    ...
    <div class="popWin_wrap">
        ...
        <tr><td colspan="2" align="center">
	        <a class="window_btn" onclick="subCallback($('#frameId').val(),'confirmUpdate')" href="javascript:void(0)">确定</a>
	        <%-- <a class="window_btn ml10" onclick="subCallback($('#frameId').val(), 'cancelDelivery')" href="javascript:void(0)">取消</a> --%>
        </td></tr>
        </tbody></table></div>
</div>

<div id="pay_type_window" class="easyui-window popWin" title="短信发送"  data-options="top:200,modal:true,shadow:false,collapsible:false,minimizable:false,maximizable:false,resizable:false,closed:true,draggable:false" >
    <div class="popWin_wrap" style="width:480px;height:300px" >
        <table border="0" cellspacing="0" cellpadding="0" >
            <tr>
                <td>客户编号</td>
            ...
            <tr>
                ...
                <td><div  class = "pay_type_window"  style="width: 292px;height: 165px" id="id_message_content"></div></td>

                <td><div ><a  href="javascript:void(0)" onclick="sendMessage()" class="phoneNums_btns" id="u2">发送</a></div>
                    <p style="text-align:left;"><label><input type="checkbox" checked="checked" value="checkbox" style="" id="send_message_check">
                        <span class = "pay_type_window">提示发送状态</span></label></p></td>
            </tr>
        </table>
    </div>
</div>
