...
<link href="${ctx}/static/style/plugins/jquery.autocomplete.css" rel="stylesheet" type="text/css" />
<link type="text/css" href="${ctx}/static/style/jquery.marquee.css" rel="stylesheet" title="default" media="all" />

<script type="text/javascript" src="${ctx}/static/js/cti/acornPhone.js"></script>
<script type="text/javascript" src="${ctx}/static/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="${ctx}/static/js/cti/acornPhoneEvents.js"></script>
<script type="text/javascript" src="${ctx}/static/js/cti/cti-api.js"></script>
<script type="text/javascript" src="${ctx}/static/js/cti/cti-callback.js"></script>
<script type="text/javascript" src="${ctx}/static/js/cti/cti-event.js"></script>
...
<script type="text/javascript" src="${ctx}/static/js/scrollFloat.js"></script>
<script type="text/javascript" src="${ctx}/static/js/easyui-lang-zh_CN.js"></script>
<%--<script type="text/javascript" src="${ctx}/static/js/plugins/jquery.scroll.js"></script>--%>
...
<script type="text/javascript" src="${ctx}/static/js/plugins/jquery.autocomplete.js"></script>
<script type="text/javascript" src="${ctx}/static/js/plugins/jquery.tablegroup.js"></script>
<script type="text/javascript" src="${ctx}/static/js/common.js"></script>
<script type="text/javascript" src="${ctx}/static/js/browser.js"></script>
<script type="text/javascript" src="${ctx}/static/js/itemsearch.js"></script>
<script type="text/javascript" src="${ctx}/static/js/itemrecommend.js"></script>
<script type="text/javascript" src="${ctx}/static/js/utils.js"></script>
<script type="text/javascript" src="${ctx}/static/js/customer/findCustomer.js"></script>
...
//        $.messager.linkbutton({ plain:true});
		$.messager.confirm('提示', '<p style="font-size:14px;height:60px;line-height: 60px;color: #666">确定退出?<p>', function(r){
			if (r){
    ...
    <table id="AcornPhone" class="appTable"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <div id="center" class="lump"  >
            ...
            <sec:authorize ifAllGranted="INBOUND_MANAGER">
...
<form id="h_hookForm" method="post">  
 <div class="form-tabs">
	...
	<span>时间&nbsp;<input id="h_contactTime" name="contactTime" disabled="false" class="easyui-datebox"/> &nbsp;&nbsp;&nbsp;&nbsp;<font color="red"><label id="warnMsg" ></label></font></span>
     <div id="d_selectTask" class="mt10"  style="display:none">
        <!--  
         <div class="clearfix ml10 mb5">
             <label class="mr10 fl" style="width:80px">
                 <input id="d_isOldTask" name="d_isOldTask" class="fl" style="margin-left:0" type="checkbox"/>重复原任务
             </label>
                <input id="d_oldMarketingPlan" class="readonly fl" style="margin:0;padding:2px" value="懒得动销售-3月份"/>
         </div>
         -->
         <div class="clearfix ml10">
             <label class=" mr10 fl" style="width:50px">选择任务</label>
             <input id="d_marketingPlan" class="fl easyui-combobox" name="d_marketingPlan"  />

         </div>
         <div class="clearfix ml10" id="v_reson">

             <label class=" mr10 fl" style="width:50px">挂机原因</label>
             <SELECT  class="fl easyui-combobox" id='d_reson' style="width:140px;height:21px;color:#666;">
                 <OPTION selected value='1'>对方忙</OPTION>
         ...
         <div class="clearfix ml10" id="v_selcontact">
             <label class=" mr10 " style="width:80px">

                 <input id="d_selcontact" name="d_selcontact" class="fl" style="margin-left:0" type="checkbox" />
                 选择联系人</label>
                <div style="height: 22px">
             <input id="d_dept"  class="easyui-combobox" name="d_dept" style="width:100px;height: 22px"  />
             <input id="d_group"  class=" easyui-combobox" name="d_group"   style="width:100px;height: 22px"/>
             <input id="d_seat" class=" easyui-combobox" name="d_seat"   style="width:100px;height: 22px"/>   </div>
             <!--
             <SELECT  class="fl easyui-combobox" id='d_marketingPlan' style="width:140px;height:21px;color:#666;"> <OPTION selected value=老客户益尔健销售计划>老客户益尔健销售计划</OPTION> <OPTION value=老客户W9900销售计划>老客户W9900销售计划</OPTION> <OPTION value=长期销售计划>长期销售计划</OPTION></SELECT>
             -->
	...
	<p style="vertical-align:top" class="">备注:<textarea  id="h_remark" name="remark" style="width:363px;height:70px;vertical-align:top"></textarea></p>
     <div style="text-align:right;padding:5px 0 0" class="clearfix"><span class="fr ml5">
         <select id="notReadyCode"  class="easyui-combobox fr">
             <option value="1204">申请外出</option><option value="1205">主管找</option><option value="1206">下线学习</option><option value="1207">听录音</option><option value="1208">帮别人处理线</option></select></span><label class="fr"><input class="fl" name="hook_st" value="2" type="radio"/>离席</label><label class="fr"><input class="fl" name="hook_st" value="1" type="radio"/>就绪(可外呼)</label><label class="fr"><input name="hook_st" class="fl" value="0" type="radio" checked="true"/>就绪</label></div>
    ...
    <p class="winBtnsBar textC"><a id="hooksave" title="电话没有挂机，请挂机!" class="window_btn easyui-tooltip"
                                   position="right"
                                   showEvent="click"
                                   href="#" >保存</a></p>
	</form>
...
<%--</div>--%>
<div id="alertWin" class="easyui-window" data-options="modal:true,shadow:false,collapsible:false,minimizable:false,maximizable:false,resizable:false,closed:true,draggable:false" style="width:400px;height:90px;padding:10px;"></div>
